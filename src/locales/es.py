LOCALES = {
    "start": """➡️ ПРАВИЛА ТОРГОВЛИ — ПРОЧТИТЕ ВНИМАТЕЛЬНО!

Для достижения максимальной эффективности сигналов крайне важны правильное управление рисками и дисциплина!

1️⃣Рискуйте не более 5% от вашего депозита на одну сделку.
