LOCALES = {
    "start": """<b>➡️ ПРАВИЛА ТОРГОВЛИ — ПРОЧТИТЕ ВНИМАТЕЛЬНО!</b>

<i>Для достижения максимальной эффективности сигналов крайне важны правильное управление рисками и дисциплина!</i>

1️⃣ <b>Рискуйте не более 5% от вашего депозита на одну сделку.</b>
Трейдинг — это долгосрочная игра. Алгоритм не гарантирует 100% выигрышных сделок, но при правильном управлении капиталом со временем можно получить прибыль.

2️⃣ <b>Не входите в сделку по сигналу через 10-15 минут после его публикации.</b>
Каждый вход рассчитан на конкретное рыночное окно. Поздний вход может означать изменение рыночной структуры.

3️⃣ <b>Никаких мартингейлов и дублирующих сделок.</b>
TRADEGEN AI работает на основе структурированного алгоритма. Он не предназначен для агрессивного увеличения депозита.

4️⃣ <b>Не вмешивайтесь в сделку без необходимости.</b>
Все необходимые параметры уже включены в сигнал. Дополнительные действия увеличивают риск.""",


    "start2":"""...Мы разработали алгоритм, который анализирует рынок без эмоций, усталости и человеческих предубеждений.

Он не торопится, не гадает и не гонится за «красивыми» сделками.
Система анализирует структуру рынка, оценивает объемы и потоки ликвидности и определяет точки входа так же, как это сделал бы опытный профессионал 🧠📊

Это чистая логика и структурированный анализ — никаких импульсивных решений.""",


    "start3":"""<b>🤖 ОТЛИЧНО, АКТИВАЦИЯ ПРОШЛА УСПЕШНО<b>

📊 Теперь вы подключены к получению торговых сигналов 

🚀 Следите за обновлениями и не пропустите первые точки входа 

‼️<b>Пожалуйста, не отключайте уведомления</b>""",
